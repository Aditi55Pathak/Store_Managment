				...
				<form class='row g-3'  id='frmAllocate' method='post'>
					...
					<div class='col-12'>
						<label for='select' class='form-label'  >Register Type</label>
							...
							<option class='active' value='0'>--Select --</option>
							<option class='active' value='1'>Deadstock</option>
								<option class='active' value='2'>Furniture</option>
								<option class='active' value='3'>Expendable</option>
								<option class='active' value='4'>Consumable</option>
							</select>					
