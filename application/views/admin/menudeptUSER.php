    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item">
                        <a class='nav-link <?php echo ($lid == 0) ? "active" : ""; ?>' href="">Deadstock Register</a>
                    </li>
                    <li class="nav-item">
                        <a class='nav-link <?php echo ($lid == 1) ? "active" : ""; ?>' href="">Furniture Register</a>
                    </li>
                    <li class="nav-item">
                        <a class='nav-link <?php echo ($lid == 2 )? "active" : ""; ?>' href="">Expendable Register</a>
                    </li>
                    <li class="nav-item">
                        <a class='nav-link <?php echo ($lid == 3) ? "active" : ""; ?>' href="">Consumable Register</a>
                    </li>
                    <li class="nav-item">
                        <a class='nav-link <?php echo ($lid == 4) ? "active" : ""; ?>' href=" ">Change Password</a>
                    </li>
