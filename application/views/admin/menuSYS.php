        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class='nav-link <?php echo ($lid == 0) ? "active" : ""; ?>' href="<?php echo base_url('users') ?> ">Users</a>
                    </li>
                    <li class="nav-item">
                        <a class='nav-link <?php echo ($lid == 1) ? "active" : ""; ?>' href="<?php echo base_url('department') ?> ">Departments</a>
                    </li>
                    <li class="nav-item">
                        <a class='nav-link <?php echo ($lid == 2) ? "active" : ""; ?>' href=" <?php echo base_url('role') ?>">Roles</a>
                    </li><li class="nav-item">
                        <a class='nav-link <?php echo ($lid == 3) ? "active" : ""; ?>' href="<?php echo base_url('emppost')?>">Posts</a>
                    </li>
                    <li class="nav-item">
                        <a class='nav-link <?php echo ($lid == 4) ? "active" : ""; ?>' href="<?php echo base_url('registercategory') ?>">Registers</a>
                    </li>
                    <li class="nav-item">
                        <a class='nav-link <?php echo ($lid == 5) ? "active" : ""; ?>' href=" ">Change Password</a>
                    </li>
