        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class='nav-link <?php echo ($lid == 1) ? "active" : ""; ?>' href="<?php echo base_url('register') ?>">Dept Register Entry</a>
                    </li>
                    <li class="nav-item">
                        <a class='nav-link <?php echo ($lid == 2) ? "active" : ""; ?>' href="<?php echo base_url('centralinward') ?>">Central Store Entry </a>
                    </li>
                    <li class="nav-item">
                        <a class='nav-link <?php echo ($lid == 3) ? "active" : ""; ?>' href="<?php echo base_url('users') ?>">Users</a>
                    </li><li class="nav-item">
                        <a class='nav-link <?php echo ($lid == 4) ? "active" : ""; ?>' href="<?php echo base_url('department') ?>">Department</a>
                    </li>
                    <li class="nav-item">
                        <a class='nav-link <?php echo ($lid == 5) ? "active" : ""; ?>' href="<?php echo base_url('allocate') ?>">Allocate</a>
                    </li>
                    <li class="nav-item">
                        <a class='nav-link <?php echo ($lid == 6) ? "active" : ""; ?>' href="<?php echo base_url('emppost') ?>">Employee Post Types</a>
                    </li>
                   <li class="nav-item">
                        <a class='nav-link <?php echo ($lid == 7) ? "active" : ""; ?>' href="<?php echo base_url('role') ?>">Role Types</a>
                    </li>
                    <li class="nav-item">
                        <a class='nav-link <?php echo ($lid == 8) ? "active" : ""; ?>' href="<?php echo base_url('registercategory') ?>">Registers view</a>
                    </li>
